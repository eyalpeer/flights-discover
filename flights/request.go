		...
		LegList: []Leg{
			{
				...
				Dtfy:            datesEnriched.ArriveStartYear,
				Dtfm:            datesEnriched.ArriveStartMonth,
				Dtfd:            datesEnriched.ArriveStartDay,
				Dtty:            datesEnriched.ArriveEndYear,
				Dttm:            datesEnriched.ArriveEndMonth,
				Dttd:            datesEnriched.ArriveEndDay,
				Somin:           0,
				Somax:           96,
			},
		},
